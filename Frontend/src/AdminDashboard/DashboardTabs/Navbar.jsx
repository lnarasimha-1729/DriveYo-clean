import { Bell, Car, CarFront, UserCircleIcon } from 'lucide-react'
        ...
        <div className="max-w-full bg-white shadow-sm">
            ...
            <div className='flex items-center justify-between max-w-[80rem] px-4 md:px-8 py-1 mx-auto'>
                ...
                <div className="flex items-center gap-4 text-sm md:text-xl lg:text-xl xl:text-2xl">
                    ...
                    {/* Admin Button */}
                    <button
                        className="flex items-center gap-2 text-lg md:text-xl lg:text-xl xl:text-base text-white py-2 rounded-lg cursor-pointer"
                    >
                        <AdminProfile/>
                    </button>
