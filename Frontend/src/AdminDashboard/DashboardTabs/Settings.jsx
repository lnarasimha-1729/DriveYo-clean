    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      <div className="flex items-center gap-0 mb-6">
        <span
          ...
          className="text-sm md:text-base lg:text-base text-blue-600 font-medium cursor-pointer"
        >
          Dashboard
        </span>
        ...
        <span className="text-sm md:text-base lg:text-base text-gray-800 font-medium">Settings</span>
      </div>
      ...
      {/* MAIN CONTAINER */}
      <div className="md:bg-white rounded-2xl md:shadow py-6 md:px-24 lg:px-24 xl:px-24 w-full mx-auto">

        <div className="flex flex-col lg:flex-row lg:justify-center gap-4">

          {/* PASSWORD SECTION */}
          <div className="rounded-2xl p-8 shadow-sm lg:w-2/5 bg-white">
            ...
            {/* Current Password */}
            <div className="mb-4">
              <label className="text-[0.875rem] md:text-[1rem] lg:text-[0.875rem] font-medium">Current Password</label>
              <div className="relative">
                <input
                  type="password"
                  placeholder="Current Password"
                  className="w-full mt-1 px-4 py-1.5 border rounded-sm text-[0.875rem]"
                />
              </div>
            </div>
            ...
            {/* New Password */}
            <div className="mb-4">
              <label className="text-[0.875rem] md:text-[1rem] lg:text-[0.875rem] font-medium">New Password</label>
              <div className="relative">
                <input
                  type="password"
            ...
            {/* Re-enter Password */}
            <div className="mb-6">
              <label className="text-[0.875rem] md:text-[1rem] lg:text-[0.875rem] font-medium">Re-enter New Password</label>
              <div className="relative">
                <input
                  type="password"
          ...
          <div className="bg-white not-first:rounded-2xl p-8 shadow-sm h-fit lg:w-2/5">
