        ...
        <div className="w-full min-h-screen bg-gray-50 px-0 py-0">
            ...
            <div className="flex items-center gap-0 mb-6 pt-4">
                <span
                    ...
                    className="text-[0.875rem] md:text-base lg:text-base text-blue-600 font-medium cursor-pointer"
                >
                    Dashboard
                </span>
                ...
                <span className="text-[0.875rem] md:text-base lg:text-base text-gray-800 font-medium">Profile</span>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#4a77d8] text-white rounded-2xl p-8 shadow-md flex flex-col items-center justify-center">
                        ...
                        <div className="relative">
                            <UserCircle className="text-black w-24 h-24 md:w-30 md:h-30 rounded-full object-cover" />


                            {/* Camera icon */}
                            <div className="absolute bottom-1 right-1 w-7 h-7 p-1 bg-white rounded-full shadow cursor-pointer">
